...
function handleFiles(files) {
  ...
  setTimeout(() => {
    ...
    fileInfo.innerHTML = `<div class="file-name"><span><strong>Name:</strong> <i>${files[0].name}</i></span> <span><strong>Size:</strong> <i>${fileSizeInKB} KB</i></span></div>  `;
...
const API_KEY = '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';
...
function addBotMessage(resultText) {
  ...
  botDiv.innerHTML = `<div class="photo" style="background-image: url(./image/pharacetamol.png);">
              <div class="online"></div>
            </div>
            <span class="text generated-bot-text typing-dots">${resultText} </span>`;
